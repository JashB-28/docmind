...
# Pin the Compose project name so every deploy manages the same container
# (otherwise the project name varies with cwd/compose-file path and a fresh run
# collides with the existing "docmind" container).
export COMPOSE_PROJECT_NAME=docmind
